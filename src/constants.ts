// Example prompt for first-time users
export const EXAMPLE_PROMPT = `Create a web page, collect the latest posts from some AI-related bloggers on platform X and display a list. @qveris.mdc`;
